...
class mail
{
  ...
  public function SendMail($receiver, $nombre, $data, $asunto, $total, $tipo)
  {
    ...
    try {
      ...
      switch ($tipo) {
        case "purchase":
          $cuerpo = file_get_contents(__DIR__ . '/../../src/views/mail_purchase.html');
          break;
        case "returns":
          $cuerpo = file_get_contents(__DIR__ . '/../../src/views/mail_returns.html');
          break;
      }
